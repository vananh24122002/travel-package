...
if(isset($_POST['id_hoadon_chi_tiet'])){
    ...
    ?>
                                ...
                                <div class="modal-title" id="exampleModalLabel" style="padding-top:2vw;">
                                      <img src="img/logon.png" style="margin-left:2%;">
                                      <div class="title-header" style="margin-left:30%;">Thông tin đơn đặt tour</div>
                                    </div>
